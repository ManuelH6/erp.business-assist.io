...
export default function BrandSettings({ userSettings, auth }: BrandSettingsProps) {
  ...
  const [settings, setSettings] = useState<BrandSettings>({
    ...
    titleText: userSettings?.titleText || 'WorkHub',
    footerText: userSettings?.footerText || `© ${new Date().getFullYear()} WorkHub. All rights reserved.`,
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      placeholder={t(`© ${new Date().getFullYear()} WorkHub. All rights reserved.`)}
                      disabled={!canEdit}
                    />
                    <p className="text-xs text-muted-foreground">
                ...
                <div className={`flex flex-col space-y-8 ${!canEdit ? 'pointer-events-none opacity-60' : ''}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {Object.entries({ blue: '#3b82f6', green: '#10b77f', purple: '#8b5cf6', orange: '#10b77f', red: '#ef4444' }).map(([color, hex]) => (
                        <Button
                          key={color}
                          type="button"
