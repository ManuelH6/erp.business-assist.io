...
namespace Workhub\Taskly\Http\Controllers;
...
use Workhub\Taskly\Events\DestroyProject;
use Workhub\Taskly\Events\DestroyProjectMilestone;
use Workhub\Taskly\Events\ProjectDeleteClient;
use Workhub\Taskly\Events\ProjectDeleteShareToClient;
use Workhub\Taskly\Events\ProjectInviteMember;
use Workhub\Taskly\Events\ProjectShareToClient;
use Workhub\Taskly\Events\UpdateProject;
use Workhub\Taskly\Events\UpdateProjectMilestone;
use Workhub\Taskly\Models\Project;
use Workhub\Taskly\Http\Requests\UpdateMilestoneRequest;
use Workhub\Taskly\Http\Requests\StoreMilestoneRequest;
use Workhub\Taskly\Http\Requests\StoreProjectRequest;
use Workhub\Taskly\Http\Requests\UpdateProjectRequest;
use Workhub\Taskly\Models\ActivityLog;
use Workhub\Taskly\Models\ProjectMilestone;
use Workhub\Taskly\Models\ProjectTask;
use Workhub\Taskly\Models\ProjectBug;
use Workhub\Taskly\Models\ProjectClient;
use Workhub\Taskly\Models\ProjectUser;
use Workhub\Taskly\Models\ProjectFile;
...
class ProjectController extends Controller
{
    ...
    public function show(Project $project)
    {
        if (Auth::user()->can('view-project') && $project->created_by == creatorId()) {
            ...
            $taskStages = \Workhub\Taskly\Models\TaskStage::where('created_by', creatorId())->orderBy('order')->get();
            $chartData = [];
            for ($i = 4; $i >= 0; $i--) {
