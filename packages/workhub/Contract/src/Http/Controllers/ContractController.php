...
namespace Workhub\Contract\Http\Controllers;

use Workhub\Contract\Models\Contract;
use Workhub\Contract\Http\Requests\StoreContractRequest;
use Workhub\Contract\Http\Requests\UpdateContractRequest;
use Workhub\Contract\Http\Requests\DuplicateContractRequest;
use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Workhub\Contract\Events\StatusChangeContract;
use Workhub\Contract\Events\CreateContract;
use Workhub\Contract\Events\UpdateContract;
use Workhub\Contract\Events\DestroyContract;
use Workhub\Contract\Models\ContractType;
