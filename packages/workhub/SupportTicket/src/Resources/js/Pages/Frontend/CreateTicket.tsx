...
interface CreateTicketProps extends Record<string, unknown> {
    categories: Category[];
    allFields?: Field[];
    customFields?: Field[];
    settings: {
                    ...
                    <Card className="mb-6 shadow-lg">
                        ...
                        <CardContent className="p-4">
                            <div className="mb-4 text-center rounded-lg overflow-hidden">
                                <img
                                    src={getImagePath('packages/workhub/SupportTicket/src/Resources/assets/images/svg/support-illustration.svg')}
                                    alt="Support"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-teal-50 p-3 rounded-lg flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">{supportInformation?.phone_support || '+229 01 67 33 40 94'}</p>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                                ...
                                quickLinks.map((link, index) => {
                                    ...
                                    return (
                                        <a
                                            key={index}
                                            href={link.link}
                                            className={`block p-4 hover:bg-teal-50 transition duration-200 text-gray-700 ${index < quickLinks.length - 1 ? 'border-b border-gray-100' : ''
                                                }`}
                                                ...
                                                <div key={field.id} className={colSpan}>
                                                    ...
                                                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-teal-400 transition-all duration-300">
                                                        <div className="space-y-1 text-center">
                                                            <img src={getImagePath('packages/workhub/SupportTicket/src/Resources/assets/images/svg/file-upload-illustration.svg')} alt="File Upload" className="h-28 mx-auto" style={{
