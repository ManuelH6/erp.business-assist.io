...
interface KnowledgeArticleProps extends Record<string, unknown> {
    article: Article;
            ...
            <Card className="bg-teal-600 overflow-hidden shadow-lg mb-8">
                <CardContent className="py-6 px-4 md:p-8 flex flex-col md:flex-row items-center">
                    ...
                    <div className="w-full md:w-2/5 flex justify-center">
                            ...
                            <img src={getImagePath('packages/workhub/SupportTicket/src/Resources/assets/images/svg/database-illustration.svg')}
