                    ...
                    <Card className="mb-6 shadow-lg">
                        ...
                        <CardContent className="p-4">
                            <div className="mb-4 text-center rounded-lg overflow-hidden">
                                <img src={`${window.location.origin}/packages/workhub/SupportTicket/src/Resources/assets/images/svg/support-illustration.svg`} alt="Support" className="mx-auto w-full h-full" />
                            </div>
                            <div className="space-y-4">
                                ...
                                <div className="bg-teal-50 p-3 rounded-lg flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">{t('Premium customers:')} <br />+229 01 67 33 40 94'</p>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    ...
                                    <div>
                                        ...
                                        <MediaPicker
                                            ...
                                            onChange={(files) => setData('attachments', Array.isArray(files) ? files : [files])}
