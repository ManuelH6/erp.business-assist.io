...
interface SearchTicketProps extends Record<string, unknown> {
    settings: {
        faq_is_on: string;
                        ...
                        <div className="p-4 md:p-6 bg-teal-600 rounded-xl overflow-hidden relative shadow-md">
                            <div className="flex flex-col-reverse md:flex-row items-center gap-6 md:gap-8">
                                <div className="w-full md:w-1/3">
                                    <img 
                                        src={getImagePath('packages/workhub/SupportTicket/src/Resources/assets/images/search-person.svg')} 
