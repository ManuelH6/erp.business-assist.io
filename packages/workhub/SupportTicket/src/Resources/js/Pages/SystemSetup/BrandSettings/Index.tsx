...
export default function BrandSettings() {
    ...
    const defaultImages = {
        logo_dark: getImagePath('/packages/workhub/SupportTicket/src/Resources/assets/images/logo.png'),
        favicon: getImagePath('/packages/workhub/SupportTicket/src/Resources/assets/images/favicon.png')
    };
