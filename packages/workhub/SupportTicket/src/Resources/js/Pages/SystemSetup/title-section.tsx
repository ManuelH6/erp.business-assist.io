...
interface TitleSectionProps extends Record<string, unknown> {
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['create_ticket.title']} />
                                            </div>
                                            <div>
                                                ...
                                                <Textarea
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['create_ticket.description']} />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['search_ticket.title']} />
                                            </div>
                                            <div>
                                                ...
                                                <Textarea
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['search_ticket.description']} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['knowledge_base.title']} />
                                            </div>
                                            <div>
                                                ...
                                                <Textarea
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['knowledge_base.description']} />
                                            </div>
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['faq.title']} />
                                            </div>
                                            <div>
                                                ...
                                                <Textarea
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['faq.description']} />
                                            </div>
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <Input
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['contact.title']} />
                                            </div>
                                            <div>
                                                ...
                                                <Textarea
                                                    ...
                                                    required
                                                />
                                                <InputError message={(errors as any)['contact.description']} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
