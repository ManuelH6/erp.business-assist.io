...
interface ClientDashboardProps extends Record<string, unknown> {
  stats: {
    totalTickets: number;
    openTickets: number;
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <Card className="relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-white to-blue-50/50 dark:from-slate-900 dark:to-blue-900/20 opacity-50"></div>
