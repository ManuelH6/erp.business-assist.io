...
namespace Workhub\SupportTicket\Http\Controllers;
...
use Workhub\SupportTicket\Events\CreateTicket;
use Workhub\SupportTicket\Events\CreateTicketConversion;
use Workhub\SupportTicket\Events\DestroyTicket;
use Workhub\SupportTicket\Events\UpdateTicket;
use Workhub\SupportTicket\Http\Requests\StoreSupportTicketRequest;
use Workhub\SupportTicket\Http\Requests\UpdateSupportTicketRequest;
use Workhub\SupportTicket\Http\Requests\StoreConversionRequest;
use Workhub\SupportTicket\Models\Ticket;
use Workhub\SupportTicket\Models\TicketCategory;
use Workhub\SupportTicket\Models\Conversion;
use Workhub\SupportTicket\Models\SupportTicketSetting;
...
class SupportTicketController extends Controller
{
    ...
    private function getBrandSettings()
    {
        ...
        return [
            'logo_dark' => $settings['logo_dark'] ?? asset('packages/workhub/SupportTicket/src/Resources/assets/images/logo.png'),
            'favicon' => $settings['favicon'] ?? '/packages/workhub/SupportTicket/src/Resources/assets/images/favicon.png',
