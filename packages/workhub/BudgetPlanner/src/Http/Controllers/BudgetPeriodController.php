...
namespace Workhub\BudgetPlanner\Http\Controllers;

use Workhub\BudgetPlanner\Models\BudgetPeriod;
use Workhub\BudgetPlanner\Http\Requests\StoreBudgetPeriodRequest;
use Workhub\BudgetPlanner\Http\Requests\UpdateBudgetPeriodRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Workhub\BudgetPlanner\Events\ActiveBudgetPeriod;
use Workhub\BudgetPlanner\Events\ApproveBudgetPeriod;
use Workhub\BudgetPlanner\Events\CloseBudgetPeriod;
use Workhub\BudgetPlanner\Events\CreateBudgetPeriod;
use Workhub\BudgetPlanner\Events\DestroyBudgetPeriod;
use Workhub\BudgetPlanner\Events\UpdateBudgetPeriod;
