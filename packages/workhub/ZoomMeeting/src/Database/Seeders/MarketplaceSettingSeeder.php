...
namespace Workhub\ZoomMeeting\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/workhub/ZoomMeeting/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'ZoomMeeting'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Zoom Meeting Module for Assist Hub',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/workhub/ZoomMeeting/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/workhub/ZoomMeeting/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/workhub/ZoomMeeting/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [
