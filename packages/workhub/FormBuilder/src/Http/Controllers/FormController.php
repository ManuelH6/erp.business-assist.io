...
namespace Workhub\FormBuilder\Http\Controllers;
...
use Workhub\FormBuilder\Events\UpdateForm;
use Workhub\FormBuilder\Events\DestroyForm;
use Workhub\FormBuilder\Events\FormConverted;
use Workhub\FormBuilder\Http\Requests\StoreFormRequest;
use Workhub\FormBuilder\Http\Requests\UpdateFormRequest;
use Workhub\FormBuilder\Http\Requests\FormFieldRequest;
use Workhub\FormBuilder\Http\Requests\StoreFormConversionRequest;
    ...
    public function getConversionData(Form $form)
    {
        if (Auth::user()->can('manage-formbuilder-conversions')) {
            ...
            return response()->json([
                ...
                'lead_pipelines' => Module_is_active('Lead') && class_exists('\Workhub\Lead\Models\Pipeline') ? \Workhub\Lead\Models\Pipeline::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'deal_pipelines' => Module_is_active('Lead') && class_exists('\Workhub\Lead\Models\DealPipeline') ? \Workhub\Lead\Models\DealPipeline::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'clients' => Module_is_active('Lead') && class_exists('\Workhub\Lead\Models\User') ? \Workhub\Lead\Models\User::where('type', 'client')->where('created_by', creatorId())->select('id', 'name')->get() : [],
                'accounts' => Module_is_active('Sales') && class_exists('\Workhub\Sales\Models\Account') ? \Workhub\Sales\Models\Account::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'opportunity_stages' => Module_is_active('Sales') && class_exists('\Workhub\Sales\Models\OpportunitiesStage') ? \Workhub\Sales\Models\OpportunitiesStage::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'contract_types' => Module_is_active('Contract') && class_exists('\Workhub\Contract\Models\ContractType') ? \Workhub\Contract\Models\ContractType::where('created_by', creatorId())->select('id', 'name')->get() : [],
                'books' => Module_is_active('InternalKnowledge') && class_exists('\Workhub\Internalknowledge\Models\Book') ? \Workhub\Internalknowledge\Models\Book::where('created_by', creatorId())->select('id', 'title as name')->get() : [],
            ]);
        } else {
