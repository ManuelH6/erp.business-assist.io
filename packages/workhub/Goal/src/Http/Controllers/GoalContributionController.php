...
namespace Workhub\Goal\Http\Controllers;

use Workhub\Goal\Http\Requests\StoreContributionRequest;
use Workhub\Goal\Http\Requests\UpdateContributionRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Goal\Models\Goal;
use Workhub\Goal\Models\GoalContribution;
use Workhub\Goal\Events\CreateGoalContribution;
use Workhub\Goal\Events\UpdateGoalContribution;
use Workhub\Goal\Events\DestroyGoalContribution;
