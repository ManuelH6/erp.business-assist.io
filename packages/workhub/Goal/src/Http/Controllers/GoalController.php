...
use Workhub\Goal\Http\Requests\StoreGoalRequest;
use Workhub\Goal\Http\Requests\UpdateGoalRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Goal\Models\Goal;
use Workhub\Goal\Models\GoalCategory;
use Workhub\Goal\Events\CreateGoal;
use Workhub\Goal\Events\UpdateGoal;
use Workhub\Goal\Events\DestroyGoal;
