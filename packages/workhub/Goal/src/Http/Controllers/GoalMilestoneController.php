...
use Workhub\Goal\Http\Requests\StoreMilestoneRequest;
use Workhub\Goal\Http\Requests\UpdateMilestoneRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Goal\Models\Goal;
use Workhub\Goal\Models\GoalMilestone;
use Workhub\Goal\Events\CreateGoalMilestone;
use Workhub\Goal\Events\UpdateGoalMilestone;
use Workhub\Goal\Events\DestroyGoalMilestone;
