...
use Workhub\Goal\Http\Requests\StoreCategoryRequest;
use Workhub\Goal\Http\Requests\UpdateCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Goal\Models\GoalCategory;
use Workhub\Goal\Events\CreateGoalCategory;
use Workhub\Goal\Events\UpdateGoalCategory;
use Workhub\Goal\Events\DestroyGoalCategory;
