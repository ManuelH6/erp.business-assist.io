...
use Workhub\Goal\Http\Requests\StoreTrackingRequest;
use Workhub\Goal\Http\Requests\UpdateTrackingRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Goal\Models\Goal;
use Workhub\Goal\Models\GoalTracking;
use Workhub\Goal\Events\CreateGoalTracking;
use Workhub\Goal\Events\UpdateGoalTracking;
use Workhub\Goal\Events\DestroyGoalTracking;
