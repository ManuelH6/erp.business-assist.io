                                        ...
                                        <div className="text-center space-y-4">
                                            ...
                                            <div className="space-y-2">
                                                {plan.free_plan ? (
                                                    ...
                                                    <div>
                                                        <div className="flex items-baseline justify-center space-x-1 mb-2 flex-wrap">
                                                            <span className="text-3xl lg:text-4xl font-black text-gray-900 break-all">
                                                                {(priceType === 'monthly' ? formatAdminCurrency(plan.package_price_monthly) : formatAdminCurrency(plan.package_price_yearly)).replace('.00', '')}
                                                            </span>
