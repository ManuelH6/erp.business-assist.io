    ...
    return (
        <section className="bg-gray-50 py-24 lg:py-32 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute -right-64 top-1/4 w-96 h-96 bg-[#F97316]/5 rounded-full blur-[100px]"></div>
                <div className="absolute -left-64 bottom-1/4 w-96 h-96 bg-[#022B3A]/5 rounded-full blur-[100px]"></div>
            </div>

            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-24">
                    <h2 className="text-[#F97316] font-semibold tracking-wide uppercase text-sm mb-3">Pourquoi choisir Assist Hub ?</h2>
                    ...
                    {features.map((feature, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-br from-transparent to-[#F97316]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                
                                <div className="relative z-10">
                                    <div className="w-14 h-14 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center mb-6 group-hover:bg-[#F97316] group-hover:border-[#F97316] transition-colors duration-300">
                                        <IconComponent className="w-7 h-7 text-[#022B3A] group-hover:text-white transition-colors duration-300" />
                                    </div>
                                    <h4 className="text-xl font-bold text-[#022B3A] mb-3 group-hover:text-[#F97316] transition-colors duration-300">
                                        {feature.title}
                                    </h4>
