...
namespace Workhub\LandingPage\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Inertia\Inertia;
use Workhub\LandingPage\Models\NewsletterSubscriber;
use Workhub\LandingPage\Http\Requests\StoreNewsletterSubscriberRequest;
use Workhub\LandingPage\Events\CreateNewsletterSubscriber;
use Workhub\LandingPage\Events\DestroyNewsletterSubscriber;
