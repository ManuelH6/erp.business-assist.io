...
namespace Workhub\Account\Http\Controllers;

use Workhub\Account\Models\VendorPayment;
use Workhub\Account\Models\VendorPaymentAllocation;
use Workhub\Account\Models\BankAccount;
use Workhub\Account\Models\DebitNote;
use Workhub\Account\Models\DebitNoteApplication;
use Workhub\Account\Http\Requests\StoreVendorPaymentRequest;
...
use Inertia\Inertia;
use Workhub\Account\Events\CreateVendorPayment;
use Workhub\Account\Events\UpdateVendorPaymentStatus;
use Workhub\Account\Events\DestroyVendorPayment;
...
class VendorPaymentController extends Controller
{
    ...
    public function getOutstandingInvoices($vendorId)
    {
        ...
        $debitNotes = \Workhub\Account\Models\DebitNote::where('vendor_id', $vendorId)
            ->where('balance_amount', '>', 0)
