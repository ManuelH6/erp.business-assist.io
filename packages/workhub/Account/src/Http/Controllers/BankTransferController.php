...
use Workhub\Account\Http\Requests\StoreBankTransferRequest;
use Workhub\Account\Http\Requests\UpdateBankTransferRequest;
use Workhub\Account\Events\CreateBankTransfer;
use Workhub\Account\Events\UpdateBankTransfer;
use Workhub\Account\Events\DestroyBankTransfer;
use Workhub\Account\Events\ProcessBankTransfer;
