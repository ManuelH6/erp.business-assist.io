...
use Workhub\Account\Http\Requests\StoreRevenueCategoriesRequest;
use Workhub\Account\Http\Requests\UpdateRevenueCategoriesRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Account\Events\CreateRevenueCategories;
use Workhub\Account\Events\DestroyRevenueCategories;
use Workhub\Account\Events\UpdateRevenueCategories;
