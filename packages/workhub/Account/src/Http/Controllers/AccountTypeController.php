...
use Workhub\Account\Http\Requests\StoreAccountTypeRequest;
use Workhub\Account\Http\Requests\UpdateAccountTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Account\Events\CreateAccountType;
use Workhub\Account\Events\DestroyAccountType;
use Workhub\Account\Events\UpdateAccountType;
