                        ...
                        <Card className="h-full bg-[#F0FDFA] dark:bg-teal-950/20 border border-[#CCFBF1] dark:border-teal-900/30 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                            <CardContent className="p-6 flex flex-row items-center justify-between w-full h-full text-[#0D9488] dark:text-teal-400">
                                <div className="flex flex-col justify-center">
                                    ...
                                    <div className="text-2xl font-bold tracking-tight mt-1.5">{stats.total_vendors || 0}</div>
                                    <p className="text-xs opacity-80 mt-1">{t('Active vendors')}</p>
                                </div>
                                <Building2 className="h-8 w-8 opacity-80 flex-shrink-0" />
                            </CardContent>
                        </Card>
                    </div>
                    <div className="cursor-pointer">
                        <Card className="h-full bg-[#F0FDF4] dark:bg-emerald-950/20 border border-[#DCFCE7] dark:border-emerald-900/30 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                            <CardContent className="p-6 flex flex-row items-center justify-between w-full h-full text-[#16A34A] dark:text-emerald-400">
                                <div className="flex flex-col justify-center">
                                    <p className="text-xs font-semibold opacity-90 uppercase tracking-wider">{t('Total Customer Payment')}</p>
                                    <div className="text-2xl font-bold tracking-tight mt-1.5">{formatCurrency(stats.total_customer_payment || 0)}</div>
                                    <p className="text-xs opacity-80 mt-1">{t('Received payments')}</p>
                                </div>
                                <ArrowDownCircle className="h-8 w-8 opacity-80 flex-shrink-0" />
                            </CardContent>
                        </Card>
                    </div>
                    <div className="cursor-pointer">
                        <Card className="h-full bg-[#FEF2F2] dark:bg-rose-950/20 border border-[#FEE2E2] dark:border-rose-900/30 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                            <CardContent className="p-6 flex flex-row items-center justify-between w-full h-full text-[#DC2626] dark:text-rose-400">
                                <div className="flex flex-col justify-center">
                                    <p className="text-xs font-semibold opacity-90 uppercase tracking-wider">{t('Total Vendor Payment')}</p>
                                    <div className="text-2xl font-bold tracking-tight mt-1.5">{formatCurrency(stats.total_vendor_payment || 0)}</div>
                                    <p className="text-xs opacity-80 mt-1">{t('Paid to vendors')}</p>
                                </div>
                                <ArrowUpCircle className="h-8 w-8 opacity-80 flex-shrink-0" />
                            </CardContent>
                        </Card>
                    </div>
                </div>
