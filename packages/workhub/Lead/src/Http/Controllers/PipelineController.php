...
use Workhub\Lead\Http\Requests\StorePipelineRequest;
use Workhub\Lead\Http\Requests\UpdatePipelineRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Lead\Events\CreatePipeline;
use Workhub\Lead\Events\UpdatePipeline;
use Workhub\Lead\Events\DestroyPipeline;
