...
namespace Workhub\Lead\Http\Controllers;

use App\Models\EmailTemplate;
use Workhub\Lead\Models\Deal;
use Workhub\Lead\Http\Requests\StoreDealRequest;
use Workhub\Lead\Http\Requests\UpdateDealRequest;
...
use Workhub\Lead\Models\ClientDeal;
use Workhub\Lead\Models\DealStage;
use Workhub\Lead\Models\Label;
use Workhub\Lead\Models\UserDeal;
...
use Workhub\Lead\Http\Requests\StoreDealCallRequest;
use Workhub\Lead\Http\Requests\UpdateDealCallRequest;
use Workhub\Lead\Http\Requests\StoreDealEmailRequest;
use Workhub\Lead\Http\Requests\StoreDealDiscussionRequest;
use Workhub\Lead\Models\ClientPermission;
use Workhub\Lead\Models\DealActivityLog;
...
use Workhub\Lead\Events\UpdateDeal;
use Workhub\Lead\Events\DestroyDeal;
use Workhub\Lead\Events\DealMoved;
use Workhub\Lead\Events\DealAddUser;
use Workhub\Lead\Events\DestroyUserDeal;
use Workhub\Lead\Events\DealAddClient;
use Workhub\Lead\Events\DestroyDealClient;
use Workhub\Lead\Events\DealAddProduct;
use Workhub\Lead\Events\DestroyDealProduct;
use Workhub\Lead\Events\DealUploadFile;
use Workhub\Lead\Events\DestroyDealFile;
use Workhub\Lead\Events\DealSourceUpdate;
use Workhub\Lead\Events\DestroyDealSource;
use Workhub\Lead\Events\DealAddDiscussion;
use Workhub\Lead\Events\DealAddCall;
use Workhub\Lead\Events\DealCallUpdate;
use Workhub\Lead\Events\DestroyDealCall;
use Workhub\Lead\Events\DealAddEmail;
        ...
        try {
            if (Auth::user()->can('view-deals')) {
                if ($deal->created_by == creatorId()) {
                    ...
                    $availableSources = \Workhub\Lead\Models\Source::where('created_by', creatorId())->get(['id', 'name']);
