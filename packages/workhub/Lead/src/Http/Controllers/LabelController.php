...
use Workhub\Lead\Http\Requests\StoreLabelRequest;
use Workhub\Lead\Http\Requests\UpdateLabelRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Lead\Models\Pipeline;
use Workhub\Lead\Events\CreateLabel;
use Workhub\Lead\Events\UpdateLabel;
use Workhub\Lead\Events\DestroyLabel;
