...
use Workhub\Lead\Http\Requests\StoreDealStageRequest;
use Workhub\Lead\Http\Requests\UpdateDealStageRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Inertia\Inertia;
use Workhub\Lead\Models\Pipeline;
use Workhub\Lead\Events\CreateDealStage;
use Workhub\Lead\Events\UpdateDealStage;
use Workhub\Lead\Events\DestroyDealStage;
