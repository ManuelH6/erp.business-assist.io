...
use Workhub\Hrm\Http\Requests\StoreWarningTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateWarningTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateWarningType;
use Workhub\Hrm\Events\DestroyWarningType;
use Workhub\Hrm\Events\UpdateWarningType;
