...
use Workhub\Hrm\Http\Requests\StoreTerminationTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateTerminationTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateTerminationType;
use Workhub\Hrm\Events\DestroyTerminationType;
use Workhub\Hrm\Events\UpdateTerminationType;
