...
use Workhub\Hrm\Models\Announcement;
use Workhub\Hrm\Http\Requests\StoreAnnouncementRequest;
use Workhub\Hrm\Http\Requests\UpdateAnnouncementRequest;
...
use Workhub\Hrm\Events\DestroyAnnouncement;
use Workhub\Hrm\Events\UpdateAnnouncement;
            ...
            $announcements = Announcement::query()
                ...
                ->where(function ($q) {
                    if (Auth::user()->can('manage-any-announcements')) {
                        ...
                        $employee = \Workhub\Hrm\Models\Employee::where('user_id', Auth::id())->first();
