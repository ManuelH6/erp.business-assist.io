...
use Workhub\Hrm\Http\Requests\StoreAllowanceRequest;
use Workhub\Hrm\Http\Requests\UpdateAllowanceRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Workhub\Hrm\Events\CreateAllowance;
use Workhub\Hrm\Events\UpdateAllowance;
use Workhub\Hrm\Events\DestroyAllowance;
