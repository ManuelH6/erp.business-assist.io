...
use Workhub\Hrm\Http\Requests\StoreAwardTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateAwardTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateAwardType;
use Workhub\Hrm\Events\DestroyAwardType;
use Workhub\Hrm\Events\UpdateAwardType;
