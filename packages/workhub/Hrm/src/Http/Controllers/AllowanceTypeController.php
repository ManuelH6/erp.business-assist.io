...
use Workhub\Hrm\Http\Requests\StoreAllowanceTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateAllowanceTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateAllowanceType;
use Workhub\Hrm\Events\DestroyAllowanceType;
use Workhub\Hrm\Events\UpdateAllowanceType;
