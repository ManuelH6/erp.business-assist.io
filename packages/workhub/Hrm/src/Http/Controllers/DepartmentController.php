...
use Workhub\Hrm\Http\Requests\StoreDepartmentRequest;
use Workhub\Hrm\Http\Requests\UpdateDepartmentRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Models\Branch;
use Workhub\Hrm\Models\Department;
use Workhub\Hrm\Events\CreateDepartment;
use Workhub\Hrm\Events\DestroyDepartment;
use Workhub\Hrm\Events\UpdateDepartment;
