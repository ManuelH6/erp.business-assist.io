...
use Workhub\Hrm\Http\Requests\StoreComplaintTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateComplaintTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateComplaintType;
use Workhub\Hrm\Events\DestroyComplaintType;
use Workhub\Hrm\Events\UpdateComplaintType;
