...
use Workhub\Hrm\Http\Requests\StoreDeductionTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateDeductionTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateDeductionType;
use Workhub\Hrm\Events\DestroyDeductionType;
use Workhub\Hrm\Events\UpdateDeductionType;
