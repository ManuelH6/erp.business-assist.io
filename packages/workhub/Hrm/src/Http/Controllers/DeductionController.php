...
use Workhub\Hrm\Models\Deduction;
use Workhub\Hrm\Models\DeductionType;
use Workhub\Hrm\Models\Employee;
use Workhub\Hrm\Http\Requests\StoreDeductionRequest;
use Workhub\Hrm\Http\Requests\UpdateDeductionRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Workhub\Hrm\Events\CreateDeduction;
use Workhub\Hrm\Events\UpdateDeduction;
use Workhub\Hrm\Events\DestroyDeduction;
