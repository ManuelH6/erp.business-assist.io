...
use Workhub\Hrm\Http\Requests\StoreLeaveTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateLeaveTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateLeaveType;
use Workhub\Hrm\Events\DestroyLeaveType;
use Workhub\Hrm\Events\UpdateLeaveType;
