...
use Workhub\Hrm\Http\Requests\StoreHolidayTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateHolidayTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateHolidayType;
use Workhub\Hrm\Events\DestroyHolidayType;
use Workhub\Hrm\Events\UpdateHolidayType;
