...
use Workhub\Hrm\Http\Requests\StoreDesignationRequest;
use Workhub\Hrm\Http\Requests\UpdateDesignationRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Models\Branch;
use Workhub\Hrm\Models\Department;
use Workhub\Hrm\Events\CreateDesignation;
use Workhub\Hrm\Events\DestroyDesignation;
use Workhub\Hrm\Events\UpdateDesignation;
