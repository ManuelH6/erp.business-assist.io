...
use Workhub\Hrm\Http\Requests\StoreEventTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateEventTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateEventType;
use Workhub\Hrm\Events\DestroyEventType;
use Workhub\Hrm\Events\UpdateEventType;
