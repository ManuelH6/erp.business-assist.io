...
use Workhub\Hrm\Models\DocumentCategory;
use Workhub\Hrm\Http\Requests\StoreDocumentCategoryRequest;
use Workhub\Hrm\Http\Requests\UpdateDocumentCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateDocumentCategory;
use Workhub\Hrm\Events\DestroyDocumentCategory;
use Workhub\Hrm\Events\UpdateDocumentCategory;
