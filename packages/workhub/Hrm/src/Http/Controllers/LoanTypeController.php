...
use Workhub\Hrm\Http\Requests\StoreLoanTypeRequest;
use Workhub\Hrm\Http\Requests\UpdateLoanTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateLoanType;
use Workhub\Hrm\Events\DestroyLoanType;
use Workhub\Hrm\Events\UpdateLoanType;
