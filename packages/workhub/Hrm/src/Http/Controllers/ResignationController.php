...
use App\Models\User;
use Workhub\Hrm\Models\Resignation;
use Workhub\Hrm\Http\Requests\StoreResignationRequest;
use Workhub\Hrm\Http\Requests\UpdateResignationRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Illuminate\Http\Request;
use Inertia\Inertia;
use Workhub\Hrm\Events\UpdateResignaionStatus;
