...
use Workhub\Hrm\Http\Requests\StoreHrmDocumentRequest;
use Workhub\Hrm\Http\Requests\UpdateHrmDocumentRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Models\DocumentCategory;
use Workhub\Hrm\Events\CreateDocument;
use Workhub\Hrm\Events\DestroyDocument;
use Workhub\Hrm\Events\UpdateDocument;
