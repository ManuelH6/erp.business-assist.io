...
use Workhub\Hrm\Http\Requests\StoreAnnouncementCategoryRequest;
use Workhub\Hrm\Http\Requests\UpdateAnnouncementCategoryRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Hrm\Events\CreateAnnouncementCategory;
use Workhub\Hrm\Events\DestroyAnnouncementCategory;
use Workhub\Hrm\Events\UpdateAnnouncementCategory;
