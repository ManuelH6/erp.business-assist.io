...
use Workhub\Hrm\Http\Requests\StoreEventRequest;
use Workhub\Hrm\Http\Requests\UpdateEventRequest;
...
use Workhub\Hrm\Events\DestroyEvent;
use Workhub\Hrm\Events\UpdateEvent;
