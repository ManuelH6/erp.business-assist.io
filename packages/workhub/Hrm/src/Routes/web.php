...
use Workhub\Hrm\Http\Controllers\IpRestrictController;

use Workhub\Hrm\Http\Controllers\PayrollController;

use Workhub\Hrm\Http\Controllers\LoanTypeController;

use Workhub\Hrm\Http\Controllers\DeductionTypeController;

use Workhub\Hrm\Http\Controllers\AllowanceTypeController;

use Workhub\Hrm\Http\Controllers\AllowanceController;

use Workhub\Hrm\Http\Controllers\DeductionController;

use Workhub\Hrm\Http\Controllers\LoanController;

use Workhub\Hrm\Http\Controllers\AttendanceController;

use Workhub\Hrm\Http\Controllers\ShiftController;

use Workhub\Hrm\Http\Controllers\LeaveApplicationController;

use Workhub\Hrm\Http\Controllers\LeaveTypeController;

use Workhub\Hrm\Http\Controllers\EventController;

use Workhub\Hrm\Http\Controllers\EventTypeController;

use Workhub\Hrm\Http\Controllers\AnnouncementController;

use Workhub\Hrm\Http\Controllers\AnnouncementCategoryController;

use Workhub\Hrm\Http\Controllers\AcknowledgmentController;

use Workhub\Hrm\Http\Controllers\DocumentController;

use Workhub\Hrm\Http\Controllers\DocumentCategoryController;

use Workhub\Hrm\Http\Controllers\HolidayController;

use Workhub\Hrm\Http\Controllers\HolidayTypeController;

use Workhub\Hrm\Http\Controllers\EmployeeTransferController;

use Workhub\Hrm\Http\Controllers\ComplaintTypeController;

use Workhub\Hrm\Http\Controllers\WarningController;

use Workhub\Hrm\Http\Controllers\WarningTypeController;

use Workhub\Hrm\Http\Controllers\ComplaintController;

use Workhub\Hrm\Http\Controllers\TerminationController;

use Workhub\Hrm\Http\Controllers\TerminationTypeController;

use Workhub\Hrm\Http\Controllers\ResignationController;

use Workhub\Hrm\Http\Controllers\PromotionController;

use Workhub\Hrm\Http\Controllers\AwardController;

use Workhub\Hrm\Http\Controllers\AwardTypeController;

use Workhub\Hrm\Http\Controllers\EmployeeController;

use Workhub\Hrm\Http\Controllers\EmployeeDocumentTypeController;

use Workhub\Hrm\Http\Controllers\DesignationController;

use Workhub\Hrm\Http\Controllers\DepartmentController;
use Illuminate\Support\Facades\Route;
use Workhub\Hrm\Http\Controllers\DashboardController;
use Workhub\Hrm\Http\Controllers\BranchController;
use Workhub\Hrm\Http\Controllers\HrmDocumentController;
use Workhub\Hrm\Http\Controllers\SystemSetupController;
use Workhub\Hrm\Http\Controllers\WorkingDaysController;
...
Route::middleware(['web', 'auth', 'verified', 'PlanModuleCheck:Hrm'])->group(function () {
    ...
    Route::prefix('hrm/leave-balance')->name('hrm.leave-balance.')->group(function () {
        Route::get('/', [\Workhub\Hrm\Http\Controllers\LeaveBalanceController::class, 'index'])->name('index');
    });
    ...
    Route::prefix('hrm/set-salary')->name('hrm.set-salary.')->group(function () {
        Route::get('/', [\Workhub\Hrm\Http\Controllers\SetSalaryController::class, 'index'])->name('index');
        Route::get('/{employee}', [\Workhub\Hrm\Http\Controllers\SetSalaryController::class, 'show'])->name('show');
        Route::put('/{employee}', [\Workhub\Hrm\Http\Controllers\SetSalaryController::class, 'update'])->name('update');
    });
    ...
    Route::prefix('hrm/overtimes')->name('hrm.overtimes.')->group(function () {
        Route::post('/', [\Workhub\Hrm\Http\Controllers\OvertimeController::class, 'store'])->name('store');
        Route::put('/{overtime}', [\Workhub\Hrm\Http\Controllers\OvertimeController::class, 'update'])->name('update');
        Route::delete('/{overtime}/{employee}', [\Workhub\Hrm\Http\Controllers\OvertimeController::class, 'destroy'])->name('destroy');
    });
