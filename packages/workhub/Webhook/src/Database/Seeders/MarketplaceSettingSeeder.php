...
namespace Workhub\Webhook\Database\Seeders;

use Illuminate\Database\Seeder;
use Workhub\LandingPage\Models\MarketplaceSetting;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/workhub/Webhook/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Webhook'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Webhook Module for Assist Hub',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'description' => 'Automatically send HTTP requests to external systems when events occur across 30+ modules in your WorkHub system. This powerful integration ensures your external applications stay synchronized with real-time data updates.',
                                'keyPoints' => ['Event-driven automation', 'Multi-module support', 'Real-time synchronization', 'External system integration'],
                                'screenshot' => '/packages/workhub/Webhook/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/workhub/Webhook/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/workhub/Webhook/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [
