...
namespace Workhub\Performance\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/workhub/Performance/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'Performance'], [
            ...
            'config_sections' => [
                'sections'           => [
                    'hero'        => [
                        'variant'               => 'hero1',
                        'title'                 => 'Performance Management System for Assist Hub',
                    ...
                    'dedication'  => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot'  => '/packages/workhub/Performance/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/workhub/Performance/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot'  => '/packages/workhub/Performance/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [
