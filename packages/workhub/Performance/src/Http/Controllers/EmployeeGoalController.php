...
use Workhub\Performance\Models\PerformanceGoalType;
use Workhub\Hrm\Models\Employee;
use Workhub\Performance\Http\Requests\StoreEmployeeGoalRequest;
use Workhub\Performance\Http\Requests\UpdateEmployeeGoalRequest;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use App\Models\User;
use Workhub\Performance\Events\CreateEmployeeGoal;
use Workhub\Performance\Events\UpdateEmployeeGoal;
use Workhub\Performance\Events\DestroyEmployeeGoal;
