...
namespace Workhub\Performance\Http\Controllers;

use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Performance\Models\PerformanceIndicatorCategory;
use Workhub\Performance\Http\Requests\StorePerformanceIndicatorCategoryRequest;
use Workhub\Performance\Http\Requests\UpdatePerformanceIndicatorCategoryRequest;
use Workhub\Performance\Events\CreatePerformanceIndicatorCategory;
use Workhub\Performance\Events\UpdatePerformanceIndicatorCategory;
use Workhub\Performance\Events\DestroyPerformanceIndicatorCategory;
