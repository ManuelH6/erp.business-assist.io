...
namespace Workhub\Paypal\Http\Controllers;
...
use Workhub\Paypal\Events\PaypalPaymentStatus;
use Inertia\Inertia;
use Srmklive\PayPal\Services\PayPal as PayPalClient;
use Workhub\Bookings\Models\BookingAppointment;
use Workhub\Bookings\Models\BookingPackage;
use Workhub\Bookings\Models\BookingCustomer;

use Workhub\LMS\Models\LMSCart;
use Workhub\LMS\Models\LMSOrder;
use Workhub\LMS\Models\LMSOrderItem;
use Workhub\LMS\Models\LMSCoupon;
use Illuminate\Support\Facades\Log;
use Workhub\BeautySpaManagement\Models\BeautyBooking;
use Workhub\BeautySpaManagement\Models\BeautyService;
use Workhub\BeautySpaManagement\Models\BeautyBookingReceipt;
use Workhub\ParkingManagement\Models\ParkingBooking;
use Workhub\Paypal\Events\BeautyBookingPaymentPaypal;
use Workhub\Paypal\Events\ParkingBookingPaymentPaypal;
use Workhub\Paypal\Events\LaundryBookingPaymentPaypal;
use Workhub\EventsManagement\Models\Event;
use Workhub\EventsManagement\Models\EventBooking;
use Workhub\EventsManagement\Models\EventBookingPayment;
    ...
    public function laundryGetPaypalStatus(Request $request)
    {
        ...
        try {
            if ($request->return_type == 'success' && $request->token) {
                ...
                if (isset($response['status']) && $response['status'] == 'COMPLETED') {
                    $booking = new \Workhub\LaundryManagement\Models\LaundryRequest();
                    $booking->name = $bookingData['name'];
                    $booking->email = $bookingData['email'];
