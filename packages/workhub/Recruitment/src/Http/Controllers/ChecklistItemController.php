...
use Workhub\Recruitment\Http\Requests\StoreChecklistItemRequest;
use Workhub\Recruitment\Http\Requests\UpdateChecklistItemRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Recruitment\Models\OnboardingChecklist;
use Workhub\Recruitment\Events\CreateChecklistItem;
use Workhub\Recruitment\Events\UpdateChecklistItem;
use Workhub\Recruitment\Events\DestroyChecklistItem;
