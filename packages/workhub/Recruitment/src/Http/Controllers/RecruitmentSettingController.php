...
namespace Workhub\Recruitment\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Recruitment\Models\RecruitmentSetting;
use Workhub\Recruitment\Models\OfferLetter;
use Workhub\Recruitment\Events\UpdateBrandSetting;
use Workhub\Recruitment\Events\UpdateAboutCompany;
use Workhub\Recruitment\Events\UpdateApplicationTips;
use Workhub\Recruitment\Events\UpdateWhatHappensNext;
use Workhub\Recruitment\Http\Requests\StoreDashboardWelcomeCardRequest;
use Workhub\Recruitment\Events\UpdateNeedHelp;
use Workhub\Recruitment\Events\UpdateTrackingFaq;
use Workhub\Recruitment\Events\UpdateOfferLetterTemplate;
    ...
    public function index()
    {
        if (Auth::user()->can('manage-recruitment-brand-settings')) {
            ...
            return Inertia::render('Recruitment/SystemSetup/BrandSettings/Index', [
                'settings' => [
                    'logo_dark' => $settings['logo_dark'] ?? 'packages/workhub/Recruitment/src/Resources/images/logo.png',
                    'favicon' => $settings['favicon'] ?? 'packages/workhub/Recruitment/src/Resources/images/favicon.png',
