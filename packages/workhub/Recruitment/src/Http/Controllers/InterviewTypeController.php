...
use Workhub\Recruitment\Http\Requests\StoreInterviewTypeRequest;
use Workhub\Recruitment\Http\Requests\UpdateInterviewTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Recruitment\Events\CreateInterviewType;
use Workhub\Recruitment\Events\UpdateInterviewType;
use Workhub\Recruitment\Events\DestroyInterviewType;
