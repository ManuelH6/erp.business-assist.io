...
use Workhub\Recruitment\Http\Requests\StoreJobTypeRequest;
use Workhub\Recruitment\Http\Requests\UpdateJobTypeRequest;
use Illuminate\Routing\Controller;
use Illuminate\Support\Facades\Auth;
use Inertia\Inertia;
use Workhub\Recruitment\Events\CreateJobType;
use Workhub\Recruitment\Events\UpdateJobType;
use Workhub\Recruitment\Events\DestroyJobType;
