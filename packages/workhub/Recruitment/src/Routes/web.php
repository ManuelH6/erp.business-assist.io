...
use Workhub\Recruitment\Http\Controllers\CandidateOnboardingController;
use Workhub\Recruitment\Http\Controllers\ChecklistItemController;
use Workhub\Recruitment\Http\Controllers\OnboardingChecklistController;
use Workhub\Recruitment\Http\Controllers\OfferController;
use Workhub\Recruitment\Http\Controllers\CandidateAssessmentController;
use Workhub\Recruitment\Http\Controllers\InterviewFeedbackController;
use Workhub\Recruitment\Http\Controllers\InterviewController;
use Workhub\Recruitment\Http\Controllers\InterviewRoundController;
use Workhub\Recruitment\Http\Controllers\CandidateController;
use Workhub\Recruitment\Http\Controllers\JobPostingController;
use Workhub\Recruitment\Http\Controllers\CustomQuestionController;
use Workhub\Recruitment\Http\Controllers\JobLocationController;

use Workhub\Recruitment\Http\Controllers\InterviewTypeController;
use Workhub\Recruitment\Http\Controllers\CandidateSourcesController;
use Workhub\Recruitment\Http\Controllers\JobTypeController;

use Workhub\Recruitment\Http\Controllers\DashboardController as RecruitmentDashboardController;
use Workhub\Recruitment\Http\Controllers\RecruitmentSettingController;
use Workhub\Recruitment\Http\Controllers\FrontendController;
use Illuminate\Support\Facades\Route;
use Inertia\Inertia;
use Workhub\Recruitment\Http\Middleware\RecruitmentSharedDataMiddleware;
