        ...
        foreach ($trainings as $training) {
            ...
            for ($i = 0; $i < $tasksPerTraining; $i++) {
                ...
                TrainingTask::create([
                    ...
                    'creator_id' => 2,
                    'created_by' => 2,
                    'created_at' => $trainingStartDate->copy()->subDays(rand(1, 10))->setTime(4, rand(0, 59), rand(0, 59))->format('Y-m-d H:i:s'),
                    'updated_at' => $trainingStartDate->copy()->addDays(rand(1, 5))->setTime(14, rand(0, 59), rand(0, 59))->format('Y-m-d H:i:s'),
                ]);
            }
        }
    }
