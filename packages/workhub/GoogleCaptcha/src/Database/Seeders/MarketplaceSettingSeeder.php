...
namespace Workhub\GoogleCaptcha\Database\Seeders;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/workhub/GoogleCaptcha/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'GoogleCaptcha'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Google reCAPTCHA Module for Assist Hub',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/workhub/GoogleCaptcha/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/workhub/GoogleCaptcha/src/marketplace/image2.png'
                            ]
                        ]
                    ],
                    'screenshots' => [
