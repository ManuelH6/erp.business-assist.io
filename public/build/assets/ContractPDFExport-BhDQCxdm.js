...
import{a as e}from"./rolldown-runtime-B0Z9INg1.js";import{t}from"./useTranslation-C0iIS_rx.js";import{r as n,t as r}from"./app-BujDEe4w.js";import{t as i}from"./button-Cr_tXiOH.js";import{t as a}from"./download-3ZJNWoHz.js";import{a as o,i as s,o as c}from"./helpers-e1zREy1G.js";import{i as l,n as u,t as d}from"./tooltip-CViVFgCd.js";var f=n();function p({contract:n,variant:p=`outline`,size:m=`sm`}){let{t:h}=t();return(0,f.jsxs)(d,{children:[(0,f.jsx)(l,{asChild:!0,children:(0,f.jsx)(i,{variant:p,size:m,onClick:()=>{let t=document.createElement(`div`);t.innerHTML=`
